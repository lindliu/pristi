    ...
    with torch.no_grad():
        ...
        with tqdm(test_loader, mininterval=5.0, maxinterval=50.0) as it:
            ...
            with open(
                ...
                print(all_generated_samples.shape, all_evalpoint.shape)
                ddd = all_generated_samples.cpu().numpy().transpose(1,0,2,3)*all_evalpoint.cpu().numpy()
                logging.info("std={}".format(np.mean(np.std(ddd, axis=0))))
